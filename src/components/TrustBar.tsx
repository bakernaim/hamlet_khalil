      ...
      <div className="relative z-10 max-w-6xl mx-auto">
        <div className="text-center mb-8 sm:mb-10">
          <div className="ornate-divider max-w-[220px] mx-auto">
            <span className="text-[#00b86a]/70 text-xs font-medium tracking-widest uppercase whitespace-nowrap px-3">
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-5 sm:gap-8">
          {trustItems.map((item, i) => (
            <div key={i} className="group flex flex-col items-center text-center">
              ...
              <p className="text-white/45 text-xs leading-relaxed max-w-[150px]">
