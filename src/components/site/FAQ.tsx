          ...
          {faq.map((item, i) => {
            ...
            return (
              <Reveal key={i} delay={i * 60}>
                <div
                  className={`rounded-2xl border bg-[#0b1828] overflow-hidden transition-colors duration-300 ${
                    open ? "border-[#00b86a]/35" : "border-[#162035] hover:border-[#00b86a]/20"
                  }`}
                >
                  <button
                  ...
                  >
                    <span className={`font-semibold text-sm sm:text-base transition-colors ${open ? "text-[#00b86a]" : "text-white"}`}>
                    ...
                    <span
                      className={`shrink-0 w-7 h-7 rounded-full border flex items-center justify-center transition-all duration-300 ${
                        open
                          ? "border-[#00b86a]/50 bg-[#00b86a]/10 text-[#00b86a] rotate-180"
                  ...
                  <div className={`faq-body ${open ? "faq-body-open" : ""}`}>
                    <div>
                      <p className="px-5 sm:px-6 pb-5 text-white/55 text-sm leading-relaxed">
