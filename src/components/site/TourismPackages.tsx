            ...
            {packages.map((pkg, i) => {
              ...
              return (
                <Reveal key={pkg.id} delay={i * 80}>
                  <article
                    id={`tourism-${pkg.slug}`}
                    className="package-card group flex flex-col rounded-2xl overflow-hidden border border-[#162035] bg-[#0b1828] h-full"
                  >
                    {/* Photo */}
                    ...
                    <div className="flex flex-col flex-1 p-4 sm:p-5">
                      ...
                      <p className="text-white/55 text-xs leading-relaxed mb-4 flex-1">{desc}</p>
