...
> = {
  OPEN: {
    ...
    en: "Booking Open",
    dot: "bg-[#00b86a]",
    chip: "bg-[#00b86a]/15 text-[#33d68a] border-[#00b86a]/30",
  },
  ALMOST_FULL: {
  ...
  DEPARTED: {
    ...
    en: "Departed",
    dot: "bg-white/40",
    chip: "bg-white/8 text-white/50 border-white/15",
  },
  CLOSED: {
    ar: "مغلقة",
    en: "Closed",
...
export default function CurrentTrips({
  ...
  return (
    <section id="trips" dir={isRTL ? "rtl" : "ltr"} className="relative py-16 sm:py-24 px-4">
      <div className="absolute inset-0 bg-[#050f1d] pattern-overlay" />
      <div className="absolute top-0 left-0 right-0 gold-divider" />

      <div className="relative z-10 max-w-7xl mx-auto">
        {/* Heading */}
        <div className="text-center mb-10 sm:mb-14">
          <span className="inline-flex items-center gap-2 text-[#00b86a] text-xs font-medium tracking-[0.2em] uppercase mb-2">
          ...
          {trips.map((trip, i) => {
            ...
            return (
              <Reveal key={trip.id} delay={i * 70}>
                <article className="package-card group flex flex-col rounded-2xl overflow-hidden border border-[#162035] bg-[#0b1828] h-full">
                  {/* Photo */}
                  <div className="relative h-40 shrink-0 overflow-hidden">
                    {trip.image ? (
                      ...
                      <div className="absolute inset-0 bg-gradient-to-br from-[#12233c] to-[#0b1828]" />
                    )}
                  ...
                  <div className="flex flex-col flex-1 p-4 sm:p-5">
                    <div className="flex items-start justify-between gap-2 mb-3">
                      <h3 className="text-white font-bold text-sm leading-snug flex-1">{title}</h3>
                      <div className="text-end shrink-0">
                        <div className="text-[#00b86a] text-lg font-bold leading-none">${trip.price}</div>
                    ...
                    {/* Dates */}
                    <div className="space-y-1.5 text-xs text-white/55 mb-3 flex-1">
                      <div className="flex items-center gap-2">
                        <span className="text-[#00b86a]">🗓️</span>
                        <span>
                      ...
                      {showSeats && (
                        <div className="flex items-center gap-2">
                          ...
                          <span className={trip.seatsLeft! <= 5 ? "text-amber-300 font-semibold" : ""}>
                            {isRTL
                    ...
                    <div className="flex items-center gap-2">
                      {isBookable ? (
                        ...
                        <span className="flex-1 text-center text-sm font-semibold py-2.5 rounded-xl bg-white/5 text-white/40 border border-white/10 min-h-[42px] flex items-center justify-center">
                      ...
                      {packageAnchor && (
                        <a
                          href={packageAnchor}
                          className="shrink-0 text-xs font-medium px-3 py-2.5 rounded-xl border border-[#00b86a]/30 text-[#00b86a] hover:bg-[#00b86a]/10 transition-colors min-h-[42px] flex items-center justify-center"
                        >
