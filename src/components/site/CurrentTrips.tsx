...
> = {
  OPEN: {
    ...
    en: "Booking Open",
    dot: "bg-[#00b86a]",
    chip: "bg-white/85 text-[#00995a] border-[#00b86a]/35",
  },
  ALMOST_FULL: {
    ar: "أوشكت على الاكتمال",
    en: "Almost Full",
    dot: "bg-amber-500",
    chip: "bg-white/85 text-amber-700 border-amber-500/40",
  },
  DEPARTED: {
    ar: "انطلقت",
    en: "Departed",
    dot: "bg-[#9aa8a1]",
    chip: "bg-white/80 text-[#5b6b63] border-[#0c1a14]/10",
  },
  CLOSED: {
    ar: "مغلقة",
    en: "Closed",
...
export default function CurrentTrips({
  ...
  return (
    <section id="trips" dir={isRTL ? "rtl" : "ltr"} className="relative py-16 sm:py-24 px-4">
      <div className="absolute inset-0 bg-[#e3ece6] pattern-overlay" />
      <div className="absolute top-0 left-0 right-0 gold-divider" />

      <div className="relative z-10 max-w-7xl mx-auto">
        {/* Heading */}
        <div className="text-center mb-10 sm:mb-14">
          <span className="inline-flex items-center gap-2 text-[#00995a] text-xs font-medium tracking-[0.2em] uppercase mb-2">
          ...
          {trips.map((trip, i) => {
            ...
            return (
              <Reveal key={trip.id} delay={i * 70}>
                <article className="package-card group flex flex-col rounded-2xl overflow-hidden border border-[#d9e3dd] bg-white h-full">
                  {/* Photo */}
                  <div className="relative h-40 shrink-0 overflow-hidden">
                    {trip.image ? (
                      ...
                      <div className="absolute inset-0 bg-gradient-to-br from-[#dcebe3] to-[#c4d9cd]" />
                    )}
                  ...
                  <div className="flex flex-col flex-1 p-4 sm:p-5">
                    <div className="flex items-start justify-between gap-2 mb-3">
                      <h3 className="text-[#0c1a14] font-bold text-sm leading-snug flex-1">{title}</h3>
                      <div className="text-end shrink-0">
                        <div className="text-[#00995a] text-lg font-bold leading-none">${trip.price}</div>
                    ...
                    {/* Dates */}
                    <div className="space-y-1.5 text-xs text-[#3d4b44] mb-3 flex-1">
                      <div className="flex items-center gap-2">
                        <span className="text-[#00995a]">🗓️</span>
                        <span>
                      ...
                      {showSeats && (
                        <div className="flex items-center gap-2">
                          ...
                          <span className={trip.seatsLeft! <= 5 ? "text-amber-600 font-semibold" : ""}>
                            {isRTL
                    ...
                    <div className="flex items-center gap-2">
                      {isBookable ? (
                        ...
                        <span className="flex-1 text-center text-sm font-semibold py-2.5 rounded-xl bg-[#0c1a14]/4 text-[#5b6b63]/70 border border-[#0c1a14]/10 min-h-[42px] flex items-center justify-center">
                      ...
                      {packageAnchor && (
                        <a
                          href={packageAnchor}
                          className="shrink-0 text-xs font-medium px-3 py-2.5 rounded-xl border border-[#00b86a]/30 text-[#00995a] hover:bg-[#00b86a]/10 transition-colors min-h-[42px] flex items-center justify-center"
                        >
