      ...
      <div className="relative z-10 max-w-6xl mx-auto">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6">
          {testimonials.map((t, i) => (
            <div
              key={i}
              className="flex flex-col rounded-2xl p-5 sm:p-6 border border-[#162035] hover:border-[#00b86a]/25 transition-colors bg-[#0b1828]"
            >
              {/* Stars */}
              ...
              <p className="text-white/65 text-sm leading-7 flex-1 mb-5">
                {isRTL ? t.quote.ar : t.quote.en}
              </p>

              {/* Reviewer */}
              <div className="flex items-center gap-3 border-t border-[#162035] pt-4">
                <div className="w-9 h-9 rounded-full bg-[#00b86a]/15 border border-[#00b86a]/20 flex items-center justify-center text-[#00b86a] font-bold text-sm shrink-0">
                ...
                <div>
                  ...
                  <div className="text-[#00b86a]/60 text-xs mt-0.5">
