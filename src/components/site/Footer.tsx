  ...
  return (
    <footer id="contact" dir={isRTL ? "rtl" : "ltr"} className="bg-[#040d18] border-t border-[#162035]">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-12 sm:pt-14 pb-8">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-2 lg:grid-cols-4 gap-8 sm:gap-10 mb-10">
          ...
          <div className="col-span-2 sm:col-span-2 lg:col-span-1">
            <div className="flex items-center gap-3 mb-4">
              <div className="relative w-10 h-10 rounded-xl overflow-hidden bg-white border border-[#00b86a]/20 shrink-0">
                <Image src="/logo.png" alt="Logo" fill className="object-contain p-1" sizes="40px" />
              </div>
              <div>
                {/* h3 → Reem Kufi */}
                <h3 className="text-base font-bold text-[#00b86a]">
            ...
            <div className="flex gap-2.5">
              <a href={WHATSAPP_URL} target="_blank" rel="noopener noreferrer"
                className="w-9 h-9 rounded-full bg-green-600/15 border border-green-600/25 flex items-center justify-center text-green-400 hover:bg-green-600/30 transition-colors">
                {WA_ICON}
              </a>
              <a href={settings.instagramUrl} target="_blank" rel="noopener noreferrer" className="w-9 h-9 rounded-full bg-pink-600/15 border border-pink-600/25 flex items-center justify-center text-pink-400 hover:bg-pink-600/30 transition-colors">
                <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24">
              ...
              <a href="#" className="w-9 h-9 rounded-full bg-blue-600/15 border border-blue-600/25 flex items-center justify-center text-blue-400 hover:bg-blue-600/30 transition-colors">
                <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24">
          ...
          <div>
            ...
            <ul className="space-y-2.5">
              {nav.links.map((link) => (
                <li key={link.href}>
                  <a href={link.href} className="text-white/45 hover:text-[#00b86a] text-sm transition-colors">
          ...
          <div>
            ...
            <ul className="space-y-2.5 text-sm text-white/45">
              {[
                ...
                <li key={p.label.en}>
                  <a href={p.href} className="hover:text-[#00b86a] transition-colors">
          ...
          <div>
            ...
            <ul className="space-y-3.5">
              ...
              <li className="flex items-center gap-2.5">
                ...
                <a href={WHATSAPP_URL} target="_blank" rel="noopener noreferrer"
                  className="text-green-400/65 hover:text-green-400 text-xs transition-colors">
                  WhatsApp
                </a>
              </li>
            </ul>
        ...
        {/* Bottom bar */}
        <div className="border-t border-[#162035] pt-5 flex flex-col sm:flex-row items-center justify-between gap-2">
          <p className="text-white/25 text-xs text-center sm:text-start">
