        ...
        <div className="grid grid-cols-2 sm:grid-cols-2 lg:grid-cols-4 gap-8 sm:gap-10 mb-10">
          ...
          <div className="col-span-2 sm:col-span-2 lg:col-span-1">
            ...
            <div className="flex gap-2.5">
              ...
              <a href="#" className="w-9 h-9 rounded-full bg-pink-600/15 border border-pink-600/25 flex items-center justify-center text-pink-400 hover:bg-pink-600/30 transition-colors">
                <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24">
